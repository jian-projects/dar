import torch, time, logging, json, math, os
...
class Processor():
    def __init__(self, args, model, dataset) -> None:
        ...
        self.metrics, self.log_show, self.global_step, self.stop = dataset.metrics, args.train['show'], 1, 0
    ...
    def epoch_deal(self, epoch=None):
    ...
    def _train(self):
        ...
        for epoch in range(start_e, epochs):
            ...
            self.train_stop(epoch) # is early stop ?
            if self.stop: break
